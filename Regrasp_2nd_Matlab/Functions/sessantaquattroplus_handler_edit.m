function sessantaquattroplus_handler
% % % Initialization
...
% createCommand(FSAMP, NCH, MODE, HRES, HPF, EXTEN, TRIG, REC, GO);
...
function data = receiveData(t, NumChan, sampFreq, HRES)
    blockData = (HRES == 1) * 3 * NumChan * sampFreq + (HRES == 0) * 2 * NumChan * sampFreq; % to make sure it will be around 80 ms (72*2000)
    ChInd = (1:3:NumChan * 3);
