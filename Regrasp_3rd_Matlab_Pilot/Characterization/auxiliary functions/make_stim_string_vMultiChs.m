function [stim_string,safe,cmdDelay,cmdTotDuration] = make_stim_string_vMultiChs(mode,stim_params,stim_params_name,safeLimit)
...
switch mode
    ...
    case 'SinglePulse'
        ...
        stim_string{1} = [elec_string cstr(elec) ',;' TL_string cstr(TL) ',;' ...
    ...
    case 'SingleBurst'
        ...
        for iE = 1:length(elec)
            ...
            stim_string{iE} = [elec_string num2str(elec(iE)) ',;' TL_string num2str(TL(iE)) ',;' ...
    ...
    case 'RC'
        ...
        for iA = 1:n_incr
            ...
            stim_string{iA} = [elec_string cstr(elec) ',;' TL_string cstr(TL) ',;' ...
                freq_string cstr(freq) ',;' PW_string cstr(PW) ',;' ...
                amp_string cstr(amp_steps) ',;' TD_string cstr(TD) ',;' ...
                FS_string cstr(FS) ',;' PL_string cstr(PL) ',;'];
    ...
    case 'AMBursts'
        ...
        for iA = 1:n_incr
            ...
            for iR = 1:reps(1)
                ...
                stim_string{(iA-1)*reps(1)+iR} = [elec_string cstr(elec) ',;' TL_string cstr(TL) ',;' ...
                    freq_string cstr(freq) ',;' PW_string cstr(PW) ',;' ...
                    amp_string cstr(amp_steps) ',;' TD_string cstr(TD) ',;' ...
                    FS_string cstr(FS) ',;' PL_string cstr(PL) ',;'];
    ...
    case 'FMBursts'
        ...
        for iF = 1:n_incr
            ...
            for iR = 1:reps(1)
                ...
                stim_string{(iF-1)*reps(1)+iR} = [elec_string cstr(elec) ',;' TL_string cstr(TL) ',;' ...
                    freq_string cstr(freq) ',;' PW_string cstr(PW) ',;' ...
                    amp_string cstr(amp_steps) ',;' TD_string cstr(TD) ',;' ...
                    FS_string cstr(FS) ',;' PL_string cstr(PL) ',;'];
