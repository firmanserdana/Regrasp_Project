...
fps = 30  # Set FPS for webcam
frame_width = int(cap.get(cv2.CAP_PROP_FRAME_WIDTH))  # Frame width from the webcam
frame_height = int(cap.get(cv2.CAP_PROP_FRAME_HEIGHT))  # Frame height from the webcam
